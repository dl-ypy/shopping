...
<body>
	...
	<form action="back/McServlet?task=add" method="post" enctype="multipart/form-data" onsubmit="return ruleNumKeyUp()&&submitFun()">   
	    <ul class="forminfo">
	    <li><label>商品名称</label><input id="name" name="mcname" type="text" class="dfinput" onkeyup="ruleNumKeyUp()"/><i id="remind">标题不能超过30个字符</i></li>
	    <li><label>商品价格</label><input name="price" id="price" type="text" class="dfinput" onkeyup="priceKeyUp()"/><i id="price_i">价格不超过10000000</i></li>
	    <li><label>商品大类</label>
		...
		<li><label>商品库存</label><input name="quantity" id="quantity" type="text" class="dfinput" onkeyup="quantityKeyUp()"/><i id="quantity_i">必须是数字，不超过10000000</i></li>
	    <li><label>商品图片</label><input name="pic" type="file"/></li>
	    <li><label>商品描述</label><textarea name="mcdecx" class="dfinput"></textarea></li>
